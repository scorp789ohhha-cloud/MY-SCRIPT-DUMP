(function () {
    ...
    function playNextTrack() {
        ...
        audio.play().catch(err => {
            // Silently catch and retry later due to browser autoplay restrictions
    ...
    // Continuous attempt to bypass browser lock on any passive window activity
    ...
    // Kick off first track attempt immediately
    playNextTrack();
    ...
    // Immediately trigger the animation timeline
    requestAnimationFrame(renderLoop);
})();
